...
Revision ID: 708468e07950
Revises: 
Create Date: 2018-05-18 16:11:01.985725
...
def upgrade():
    ...
    sa.Column('id_card', sa.String(length=20), nullable=False),
    ...
    sa.Column('areaage', sa.Integer(), nullable=True),
